...
import org.ywojctb.task.tracker.api.factories.TaskStateDtoFactory;
...
import org.ywojctb.task.tracker.store.repositories.TaskStateRepository;
...
public class TaskStateController {
    ...
    public TaskStateDto createTaskState(
        ...
        final TaskStateEntity savedTaskSate = taskStateRepository.saveAndFlush(taskState);

        return taskStateDtoFactory.makeTaskStateDto(savedTaskSate);
    }
